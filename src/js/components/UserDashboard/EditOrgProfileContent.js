...
class EditOrgProfileContent extends React.Component {
    constructor (props) {
        super(props);
        this.state = {
    ...
    handleSubmit(event){
        this.props.organizationAction.OrgUpdateAction(
            ...
            >
                ...
                <Form>
                    <Form.Group controlId="formBasicEmail">
                        ...
                        <Form.Control type="text" onChange={this.changeOrgName} defaultValue={this.props.session.organizationName} />
...
export default EditOrgProfileContent;